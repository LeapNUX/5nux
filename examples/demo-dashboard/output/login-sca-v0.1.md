...
**Version:** v0.1
**Date:** 2026-05-01
**Prepared by:** BranchNuX automated SCA generator (reference example)
**Standards:** OWASP ASVS 4.0 (general) · WCAG 2.2 AA (general)
**Status:** DRAFT — requires human attestation

> This document is a public reference SCA produced by BranchNuX against the demo-dashboard application. It demonstrates the 8-section SCA structure and the `[VERIFY]` confidence-marker convention. It is not a client engagement artifact.
...
This SCA was generated from the BranchNuX test pass `2026-05-01_demo-dashboard-login`. The pipeline:
...
4. **SCA generated:** BranchNuX SCA template populated from test results and source-code inspection
...
This SCA is a draft generated by BranchNuX from automated test results. It must be reviewed and attested by a named human before submission to an external auditor or compliance officer.
...
*Generated by BranchNuX v0.1 · OWASP ASVS 4.0 · WCAG 2.2 AA · Apache 2.0*
