 ...
 *
 * Implements `branchnux sign pdf <surface>` — render a UAT sign-off ledger to PDF.
 *
 * Usage:
 *   branchnux sign pdf <surface>
...
<head>
<meta charset="UTF-8">
<title>BranchNuX — UAT Sign-off Ledger — ${surface}</title>
<style>
...
<div class="page-wrap">
  ...
  <div class="footer">
    Generated by BranchNuX v0.2.0-alpha. The HMAC-SHA256 chain in uat-log.jsonl is the
