...
export function buildHtml(tcs, opts = {}) {
  ...
  const html = `<!-- Apache 2.0 — Copyright 2026 Chu Ling — Generated by TrunkNuX -->
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
  ...
  <aside class="sidebar">
    <div class="sidebar-brand">
      <div class="brand-logo">
        ...
        <div>
          <div class="brand-name">TrunkNuX</div>
  ...
  <main class="main">
    ...
    <div class="page-header" id="summary">
      ...
      <div class="meta-row">
        ...
        <div class="meta-item"><strong>Tool</strong><span class="meta-sep">·</span>TrunkNuX ${VERSION}</div>
      </div>
    </div>
    ...
    <div class="page-footer">
      <strong>Generated by</strong> <a href="https://github.com/StillNotBald/trunknux" target="_blank" rel="noopener">TrunkNuX ${VERSION}</a>
      &nbsp;·&nbsp; ${generatedAt}
