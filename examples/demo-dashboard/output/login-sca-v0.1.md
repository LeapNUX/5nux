...
**Version:** v0.1
**Date:** 2026-05-01
**Prepared by:** TrunkNuX automated SCA generator (reference example)
**Standards:** OWASP ASVS 4.0 (general) · WCAG 2.2 AA (general)
**Status:** DRAFT — requires human attestation

> This document is a public reference SCA produced by TrunkNuX against the demo-dashboard application. It demonstrates the 8-section SCA structure and the `[VERIFY]` confidence-marker convention. It is not a client engagement artifact.
...
This SCA was generated from the TrunkNuX test pass `2026-05-01_demo-dashboard-login`. The pipeline:
...
4. **SCA generated:** TrunkNuX SCA template populated from test results and source-code inspection
...
This SCA is a draft generated by TrunkNuX from automated test results. It must be reviewed and attested by a named human before submission to an external auditor or compliance officer.
...
*Generated by TrunkNuX v0.1 · OWASP ASVS 4.0 · WCAG 2.2 AA · Apache 2.0*
