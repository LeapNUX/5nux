...
Opens a sample execution report in your browser. This is the artifact `branchnux report` produces. If this looks like the kind of evidence you want, continue.

### 5 minutes — scaffold your first test pass

```
branchnux init my-page
```
...
4. Generate the report: `branchnux report testing-log/2026-04-27_my-page`
5. Open the generated `.html` — it's a self-contained file you can email to an auditor

You now have the full loop. From here, scale: more pages, more TCs, `branchnux rtm` for traceability across all pages, `branchnux sign` for sign-off ledger, `branchnux sca` for control assessments.
...
- **Architecture** — [architecture/data-model.md](architecture/data-model.md) if you want to understand the data model before extending BranchNuX
